...
CustomVideo::CustomVideo(CustomPlaystatus *playstatus, CustomCallJava *wlCallJava) {
...
void * playVideo(void *data)
{
    ...
    CustomVideo *video = static_cast<CustomVideo *>(data);
...
double CustomVideo::getFrameDiffTime(AVFrame *avFrame, AVPacket *avPacket) {
...
double CustomVideo::getDelayTime(double diff) {
