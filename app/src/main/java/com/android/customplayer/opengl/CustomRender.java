...
import com.android.customplayer.R;
...
public class CustomRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    {
        String vertexSource = CustomShaderUtils.readRawTxt(context, R.raw.vertex_shader);
        String fragmentSource = CustomShaderUtils.readRawTxt(context, R.raw.fragment_yuv);
        program_yuv = CustomShaderUtils.createProgram(vertexSource, fragmentSource);
    ...
    {
        String vertexSource = CustomShaderUtils.readRawTxt(context, R.raw.vertex_shader);
        String fragmentSource = CustomShaderUtils.readRawTxt(context, R.raw.fragment_mediacodec);
        program_mediacodec = CustomShaderUtils.createProgram(vertexSource, fragmentSource);
