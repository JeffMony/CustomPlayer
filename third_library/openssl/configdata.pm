...
our %config = (
  ...
  openssldir => "/Users/tianpeng/sources/CustomPlayer/third_library/openssl/android/arm64",
  options => "-D__ANDROID_API__=24 --prefix=/Users/tianpeng/sources/CustomPlayer/third_library/openssl/android/arm64 --openssldir=/Users/tianpeng/sources/CustomPlayer/third_library/openssl/android/arm64 no-afalgeng no-asan no-buildtest-c++ no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-engine no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "darwin-thread-multi-2level",
  perl_cmd => "perl",
  perl_version => "5.18.4",
  perlargv => [ "android-arm64", "-D__ANDROID_API__=24", "no-shared", "no-ssl2", "no-ssl3", "no-comp", "no-hw", "no-engine", "--prefix=/Users/tianpeng/sources/CustomPlayer/third_library/openssl/android/arm64", "--openssldir=/Users/tianpeng/sources/CustomPlayer/third_library/openssl/android/arm64" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "/Users/tianpeng/sources/CustomPlayer/third_library/openssl/android/arm64",
  processor => "",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -mandroid --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-24/arch-arm64",
  ...
  cxxflags => "-std=c++11 -pthread  -mandroid --sysroot=\$(ANDROID_NDK_HOME)/platforms/android-24/arch-arm64",
  defines => [  ],
